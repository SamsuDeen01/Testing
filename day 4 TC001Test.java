...
public class TC001Test {
  ...
  public void tC001() {
    ...
    driver.findElement(By.id("input-firstname")).sendKeys("Samsudeen");
    driver.findElement(By.id("input-lastname")).click();
    driver.findElement(By.id("input-lastname")).sendKeys("Former");
    driver.findElement(By.id("input-email")).click();
    driver.findElement(By.id("input-email")).sendKeys("sample@gmail.com");
    driver.findElement(By.id("input-password")).click();
    driver.findElement(By.id("input-password")).sendKeys("samplePass");
